...
public class aboutus extends JPanel {
    public aboutus(JPanel lastVisitedPanel){
        ...
        ImageIcon image =new ImageIcon("C:\\Users\\Arnav\\OneDrive\\Desktop\\3rdSem-Projects\\APP\\java_project\\LFG\\imagemin.png");
        ...
        des.setText("Ever been excited about trying new food, only to be disappointed? We've all been there. That's why we made the SRM Food Guider App. We want to stop those letdowns and make eating out more fun. We thought, what if people could share their restaurant experiences? That's the idea!We want to create a place where you and others can talk about good and not-so-good food moments.\n\n" +
                "Arnav Gupta\n" +
                "Arvind Pandey\n" +
                "Ayush Bisht");
         JLabel contact=new JLabel("Contact : foodguidersrm@gmail.com");
